...
/* Props interface for resource search header component */
interface ResourceSearchHeaderProps {
...
/* Header component with search and create functionality for resources */
const ResourceSearchHeader: React.FC<ResourceSearchHeaderProps> = ({
  title,
  showSearch,
  searchTerm,
  onSearchToggle,
