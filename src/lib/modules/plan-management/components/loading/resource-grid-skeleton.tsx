...
/* Props interface for resource grid skeleton component */
...
/* Grid of skeleton cards for resource loading states */
const ResourceGridSkeleton: React.FC<ResourceGridSkeletonProps> = ({
