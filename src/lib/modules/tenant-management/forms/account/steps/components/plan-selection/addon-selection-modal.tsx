...
import { applyBillingCycleDiscount } from '@tenant-management/utils'
...
const AddonSelectionModal: React.FC<AddonSelectionModalProps> = ({
  ...
  const addonPrice = addon ? applyBillingCycleDiscount(addon.add_on_price, billingCycle, planDiscountPercentage) : 0
                    ...
                    <Flex p={4} w={'100%'} justifyContent="space-between" alignItems="center" >
                      ...
                      <Flex flexDir={'column'}>
                        <Text fontSize="xl" fontWeight="bold" color={PRIMARY_COLOR}>
                          ${addonPrice}/{billingCycle === 'yearly' ? 'year' : 'month'}
                        </Text>
                            ...
                            >
                              <Flex justifyContent={'space-between'} align="flex-start">
                                ...
                                <Flex flexDir="column" gap={2} flex={1} minH={0}>
                                  ...
                                  >
                                    Branch {selection.branchIndex + 1}
                                  </Text>
                          ...
                          <Flex alignItems="center" gap={3}>
                            ...
                            <Box>
                              ...
                              <Text fontSize="sm" color="blue.700">
                                ...
                                The cost is ${addonPrice} per {billingCycle === 'yearly' ? 'year' : 'month'} for the organization.
                              </Text>
                            </Box>
                          </Flex>
                        </Box>
